...
int main( int argc, char * * argv ){
	...
	FONT font_def = FONT( 8, 8 ); 
	
	font_def.load( (char *)"\fonts/def_lower_case.bmp", (char *)"fonts/def_upper_case.bmp" );
	font_def.map_lower(0, 97, 127);

    font_def.map_lower(30, 32, 64);

    font_def.map_upper( 0, 65, 91 );
    font_def.to_string();
