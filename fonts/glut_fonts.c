...
draw_stuff()
{
   ...
   char* bitmap_font_names[7] = {
      (char *)"GLUT_BITMAP_9_BY_15",
      (char *)"GLUT_BITMAP_8_BY_13",
      (char *)"GLUT_BITMAP_TIMES_ROMAN_10",
      (char *)"GLUT_BITMAP_TIMES_ROMAN_24",
      (char *)"GLUT_BITMAP_HELVETICA_10",
      (char *)"GLUT_BITMAP_HELVETICA_12",
   ...
   char* stroke_font_names[2] = {
         (char *)"GLUT_STROKE_ROMAN",
         (char *)"GLUT_STROKE_MONO_ROMAN"
   };
